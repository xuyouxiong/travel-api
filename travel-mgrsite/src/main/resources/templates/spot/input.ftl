    ...
    <script>
        ...
        $(function () {
            ...
            $("#btn_submit").click(function () {
                ...
                let content = $("#content").val(ck.getData())
            ...
            <div class="row col-sm-10">
                <form class="form-horizontal" action="/hotel/saveOrUpdate" method="post" id="editForm">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="name" name="name" value="" placeholder="请输入景点名称">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="price" name="price" value="" placeholder="请输入最低价格">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name" class="col-sm-2 control-label">门票数量：</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="number" name="number" value='' placeholder="请输入数量">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <textarea id="content" name="content.content" class="ckeditor"></textarea>
                    </div>
