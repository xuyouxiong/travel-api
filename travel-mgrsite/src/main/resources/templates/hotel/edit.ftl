        ...
        <div class="col-sm-10">
            ...
            <div class="row col-sm-10">
                <form class="form-horizontal" action="/hotel/saveOrUpdate" method="post" id="editForm">
                    <input type="hidden" name="id" value='${hotel.id}' id="id">
                    <div class="form-group">
                        <label for="name" class="col-sm-2 control-label">酒店名称：</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="name" name="name" value='${hotel.name}' placeholder="请输入酒店名称">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="hidden"  class="form-control" id="coverUrl"  name="coverUrl" value='${hotel.image}' >
                            <img src="${hotel.image}" width="100px" id="imgUrl" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="address" name="address" value='${hotel.address}' placeholder="请输入地址">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="low_price" name="low_price" value='${hotel.lowPrice}' placeholder="请输入最低价格">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="startDate" name="startDate" value='${hotel.startDate}' placeholder="开始时间">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="endDate" name="endDate" value='${hotel.endDate}' placeholder="结束时间">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea  class="form-control" name="summary" id="summary">${hotel.summary}</textarea>
                        </div>
                    </div>
