...
<div class="container-fluid" style="margin-top: 20px">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="row">
                <div class="col-sm-12">
                    <h1 class="page-head-line">房间管理</h1>
                </div>
            </div>
            ...
            <form class="form-inline" id="searchForm" action="/strategy/list" method="get">
                ...
                <a href="/room/roomAdd?id=${id}" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span>添加</a>
            </form>
            ...
            <table class="table table-striped table-hover">
                ...
                <#list page.records as entity>
                    <tr>
                        ...
                        <td>${(entity.number)!}</td>
                        <td>${(entity.price)!}</td>
                        <td>${(entity.hotelName)!}</td>
                        <td>正常</td>
                        <td>
                            <a class="btn btn-info btn-xs inputBtn" href="/room/roomEdit?id=${entity.id}">
                                <span class="glyphicon glyphicon-edit"></span> 编辑
                            </a>
                            <a href="javascript:;" class="btn btn-danger btn-xs deleteBtn"
                               data-url="/room/delete?id=${entity.id}">
